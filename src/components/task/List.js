								...
								switch (JSON.parse(this.state.tasklist[this.state.taskkind].definitionJSON).scaleType) {
									...
									case 'bar': {
										switch (JSON.parse(this.state.tasklist[this.state.taskkind].definitionJSON).maxSize) {
											case '5': return <NodeRate tasknum={(index) => this.handleTaskkind(index)} task={this.state.tasklist[this.state.taskkind]} />
											case '10': return <NodeBigRate tasknum={(index) => this.handleTaskkind(index)} task={this.state.tasklist[this.state.taskkind]} />
										}
